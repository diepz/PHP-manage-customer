...
class XmlFileLoaderTest extends TestCase
{
    ...
    public function testLoadWithRoute()
    {
        ...
        $this->assertSame('MyBundle:BlogController:show', $route->getDefault('_controller'));
    ...
    public function testScalarDataTypeDefaults()
    {
        ...
        $this->assertSame(
            array(
                '_controller' => 'AcmeBlogBundle:BlogController:index',
                'slug' => null,
                'published' => true,
                'page' => 1,
                'price' => 3.5,
    ...
    public function testLoadRouteWithControllerSetInDefaults()
    {
        ...
        $this->assertSame('AppBundle:BlogController:list', $route->getDefault('_controller'));
    }
